...
class _EmployeeQRPageState extends State<EmployeeQRPage> {
  ...
  final MobileScannerController _scannerController = MobileScannerController(
    formats: [BarcodeFormat.qrCode], // sadece QR
    detectionSpeed: DetectionSpeed.noDuplicates, // tekrarları azalt
    facing: CameraFacing.back,
    torchEnabled: false,
  );

  bool _isProcessing = false; // aynı anda birden fazla kontrolü engelle
  DateTime? _lastScanAt; // hızlı tekrarı filtrele
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "• Müşterinin gösterdiği QR’ı kameraya tut.\n"
            "• Siparişi gör, onayla veya reddet.\n"
            "• Hesap QR’ı ile yıldız ekle/sil.",
